...
- Main merge commit: `22f366cbc00200a1c19f249bfb4f2136a599de30` (PR #28)
- Production deployment: `dpl_4BCsj35gTojSyWrPKxhsX1hny4RZ` (READY)
...
- Vercel production deployment `dpl_4BCsj35gTojSyWrPKxhsX1hny4RZ` → READY after PR #28.
- Self-hosted verification run #48 → SUCCESS.
