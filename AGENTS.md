...
## Authoritative current state — 2026-09-19

The connected production database follows the Aqarat OS migration lineage. The current certified runtime contract is the public Aqarat property experience. Historical relational assumptions in this document are retained only as historical context and must not be treated as live schema evidence.

- **Production:** https://sadat-mls.vercel.app
- **Current main:** `0e603135cb7c2f87c3c2d00b1be0a56bf0f5946f`
- **Production deployment:** `dpl_2nRKvAmLKcRSUpRwk7UkgcbDDJEs` (READY)

## Project Context
Bilingual (Arabic/English) real estate MLS platform for Sadat City, Egypt.
- **Stack:** Next.js 16.2.10 (App Router), Supabase, Tailwind CSS 4, TypeScript
...
# Testing
npm run test:run               # Unit tests (Vitest) — historical unit-test count from 2026-07-06; use current workflow results as source of truth
...
│   ├── __tests__/                # Unit Tests (45 files, historical unit-test count)
├── supabase/
...
| **Tests** | ✅ | **710 unit tests** (45 files) + **historical E2E test count** (12 files) passing |
