...
## Project Overview
Bilingual (Arabic/English) real estate MLS platform for Sadat City, Egypt. Built with Next.js 14 App Router, Supabase, Tailwind CSS 4, and TypeScript.

**Production URL:** https://sadat-5781ts4my-jmls-projects.vercel.app  
