-- Final hardening for the public SECURITY DEFINER RPC boundary.
-- Keep the functions API-visible, but pin their search_path to the empty path.
-- All application relations/types are schema-qualified inside the function body.

alter function public.increment_public_rate_limit(text, text) set search_path = '';
