                ...
                {properties.map((p) => (
                  <th key={p.id} className="p-4 text-center min-w-[200px] relative" scope="col">
                    <button
                      ...
                      className="absolute top-2 end-2 p-1 text-gray-500 hover:text-red-500 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-navy-500 focus-visible:ring-offset-2 rounded"
              ...
              <tr className="border-b">
                ...
                {properties.map((p) => (
                  <td key={p.id} className="p-4 text-center">
                    {p.price?.toLocaleString(typedLocale === "ar" ? "ar-EG" : "en-US")} {dict.property.priceUnit}
                  </td>
                ))}
              </tr>
              <tr className="border-b">
