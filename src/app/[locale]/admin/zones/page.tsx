              ...
              <PaginatedTable
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    render: (zone) => (
                      <div className="flex items-center gap-2">
                        <button onClick={() => handleEdit(zone)} aria-label={`${dict.common.edit} ${zone.name_ar}`} className="p-2 rounded-lg hover:bg-blue-50">
                          <span className="text-blue-500">{dict.common.edit}</span>
                        </button>
                        <button onClick={() => confirmDelete(zone.id)} aria-label={`${dict.common.delete} ${zone.name_ar}`} className="p-2 rounded-lg hover:bg-red-50">
