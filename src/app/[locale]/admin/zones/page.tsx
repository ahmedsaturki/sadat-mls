              ...
              <PaginatedTable
                ...
                columns={[
                  ...
                  },
                  {
                    ...
                    render: (zone) => (
                      <div className="flex items-center gap-2">
                        <button onClick={() => handleEdit(zone)} aria-label={`${dict.common.edit} ${zone.name_ar}`} className="p-2 rounded-lg hover:bg-blue-50 transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-500 focus-visible:ring-offset-2">
